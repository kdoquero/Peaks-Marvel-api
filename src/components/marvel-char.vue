...
export default {
  ...
  methods: {
    previous(){
        this.offsetPage += 20
        axios.get(`https://gateway.marvel.com:443/v1/public/characters?limit=20&offset=${this.offsetPage}&ts=1&apikey=e85adc0f267a5fe649a69a2c2b279f1b&hash=91bb9381c50e43b2e4342767278a5131`).then((response) =>  {
